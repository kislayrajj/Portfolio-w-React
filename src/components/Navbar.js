    ...
    <div>
      <nav className="navbar h-auto w-screen flex justify-around p-3 fixed  z-10 rela\">
        ...
        <div
          ...
          className="burger text-2xl absolute right-0 top-4 md:right-8 md:top-4 cursor-pointer md:hidden"
        >
          <i
            class="fa-solid fa-ellipsis-vertical h-10 w-10"
            name={IsBurger ? "close" : "menu"}
          ></i>
        </div>
        <div className={`menu-1 m-2 `}>
          <ul
            className={`md:flex text-xl text-white lg:gap-20 md:gap-10  absolute md:static  w-screen md:z-auto left-0 md:w-auto md:pl-0 pl-20 transition-all duration-500 ease-in-out ${
          ...
          >
            ...
            <li className=" cursor-pointer hover:text-green-500 md:hover:scale-[1.4] hover:font-bold">
              About
            </li>
            <Link to="/Projects">
              <li
        ...
        <div className="menu-2 m-2">
          <ul className="flex gap-5 md:gap-10">
            <li className="cursor-pointer hover:text-green-500 hover:scale-[1.4]">
              FAQs
            </li>
            <li
        ...
        >
          <button className="border-2 border-l-black border-t-black border-r-teal-200 border-b-teal-100 bg-transparent backdrop-blur-[1px] p-1 pl-5 pr-5 hover:text-green-500 absolute md:static top-14 right-6  md:mr-0 md:mt-1">
            Hire
          </button>
        </a>
      </nav>
