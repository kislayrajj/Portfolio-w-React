...
const NameLogoGsap = () => {
  ...
  return (
    <div className="relative flex items-center">
      <h1
        ref={textRef}
        className="lg:hidden xl:block text-lg  lg:text-xl xl:text-2xl 2xl:text-5xl grad font-bold leading-tight">
        Kislay Raj
      </h1>
      <svg
        ref={svgRef}
        ...
        {themeColor === "dark" ? (
          ...
          <circle cx="50" cy="50" r="40" stroke="deepPink" strokeWidth="5" />
        )}
        {themeColor === "dark" ? (
          <circle cx="50" cy="50" r="30" stroke="blue" strokeWidth="5" />
        ) : (
          <circle cx="50" cy="50" r="30" stroke="#06D001" strokeWidth="5" />
        )}

        {themeColor === "dark" ? (
          <circle cx="50" cy="50" r="20" stroke="#06D001" strokeWidth="5" />
        ) : (
          <circle cx="50" cy="50" r="20" stroke="blue" strokeWidth="5" />
        )}
        {/* <circle cx="50" cy="50" r="30" stroke="blue" strokeWidth="5" />
        <circle cx="50" cy="50" r="20" stroke="#06D001" strokeWidth="5" /> */}
