          ...
          <div className="relative mt-10 lg:mt-0 ">
            <motion.span
              ...
              className={` lg:absolute               transition-all duration-500 ease-in-out lg:text-5xl ${
                themeColor === "dark"
                  ? "text-white lg:hover:bg-gradient-to-r lg:hover:from-slate-300 lg:hover:to-slate-500 lg:hover:bg-clip-text lg:hover:text-transparent"
                  : "text-black lg:hover:bg-gradient-to-r lg:hover:from-rose-400 lg:hover:to-red-500 lg:hover:bg-clip-text lg:hover:text-transparent"
              }`}>
              Send me a text
            </motion.span>{" "}
            <i className="fa-solid fa-paper-plane lg:absolute lg:text-5xl lg:right-12 lg:hover:scale-105"></i>
            <div
